...
1. Жди сообщений от writer в формате: `Generate cover: slug=<slug>, title="<title>"`, где slug соответствует имени .md-файла без расширения (например, `2026-04-22-google-tpu-v8-inference`). Одна новость = одна статья = одна обложка; никаких `*-digest.webp`.
